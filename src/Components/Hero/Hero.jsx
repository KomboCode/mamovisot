  ...
  return (
    <div className='hero container'>
      <div className="hero-text">
        ...
        <h1>Find your favorite series on Manemovies Store and Enjoy movie streaming with our online movie collection</h1>
        <p>Movies has helped us to understand the meaning of life and it has helped 
        us become better people. Each time we watch a new movie, we see the world with new eyes.
        </p>
